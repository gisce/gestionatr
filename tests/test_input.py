...
class test_C1(unittest.TestCase):
    ...
    def test_c101_completo(self):
        ...
        self.assertEqual(c.cliente.razon_social, 'ACC Y COMP DE COCINA MILLAN Y MUNOZ')
        self.assertEqual(c.cliente.nombre, 'ACC Y COMP DE COCINA MILLAN Y MUNOZ')
...
class test_C2(unittest.TestCase):
    ...
    def test_c201_completo(self):
        ...
        self.assertEqual(cliente.nombre, 'ACC Y COMP DE COCINA MILLAN Y MUNOZ')
        self.assertEqual(cliente.razon_social, 'ACC Y COMP DE COCINA MILLAN Y MUNOZ')
...
class test_M1(unittest.TestCase):
    ...
    def test_m101(self):
        ...
        self.assertEqual(cliente.razon_social,
                         'ACC Y COMP DE COCINA MILLAN Y MUNOZ')
        self.assertEqual(cliente.telfono_numero, '666777888')
        self.assertEqual(cliente.telfono_prefijo_pais, '34')
        self.assertEqual(cliente.tipo_identificador, 'NI')
        self.assertEqual(cliente.tipo_persona, 'J')
...
class test_R1(unittest.TestCase):
    ...
    def test_r101(self):
        ...
        self.assertEqual(cli.razon_social, 'ACC Y COMP DE COCINA MILLAN Y MUNOZ')
        ...
        self.assertEqual(rec.razon_social, 'ACC Y COMP DE COCINA MILLAN Y MUNOZ')

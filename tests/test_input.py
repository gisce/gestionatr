...
class test_A1_41(unittest.TestCase):
    ...
    def test_a341(self):
        ...
        self.assertEqual(a1_41.readingtype, u'A')
...
class test_B70(unittest.TestCase):
    ...
    def test_b7031(self):
        ...
        self.assertEqual(fact.numeroexpediente, '1234567891234567')
        ...
        self.assertEqual(num.tipolec, 'A')
...
class test_A1_02(unittest.TestCase):
    ...
    def test_a302(self):
        ...
        self.assertEqual(a302.readingtype, u'A')
    ...
    def test_a3s02(self):
        ...
        self.assertEqual(a3s02.readingtype, u'A')
...
class test_A12_26(unittest.TestCase):
    ...
    def test_a1226(self):
        ...
        self.assertEqual(a1226.readingtype, u"A")
...
class test_A12_24(unittest.TestCase):
    ...
    def test_a1224(self):
        ...
        self.assertEqual(a1224.readingtype, u"A")
...
class test_A1_49(unittest.TestCase):
    ...
    def test_a349(self):
        ...
        self.assertEqual(a349.readingtype, 'A')
    ...
    def test_a3s49(self):
        ...
        self.assertEqual(a3s49.readingtype, 'A')
...
class test_A13_50(unittest.TestCase):
    ...
    def test_a15s50(self):
        ...
        self.assertEqual(a15s50.readingtype, 'A')
...
class test_A21_36(unittest.TestCase):
    ...
    def test_a2136(self):
        ...
        self.assertEqual(a2136.indconectadoplantasatelite, 'S')
...
class test_A1_42(unittest.TestCase):
    ...
    def test_a342(self):
        ...
        self.assertEqual(a342.readingtype, 'A')
    ...
    def test_a3s42(self):
        ...
        self.assertEqual(a1_42.readingtype, u'A')
...
class test_A1_51(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.xml_a251 = open(get_data("a251.xml"), "rb")
        self.xml_a2851 = open(get_data("a2851.xml"), "rb")
        self.xml_a2951 = open(get_data("a2951.xml"), "rb")
        self.xml_a2551 = open(get_data("a2551.xml"), "rb")
        self.xml_a2651 = open(get_data("a2651.xml"), "rb")
        self.xml_a351 = open(get_data("a351.xml"), "rb")
        self.xml_a3s51 = open(get_data("a3s51.xml"), "rb")
        self.xml_a451 = open(get_data("a451.xml"), "rb")
        self.xml_a4s51 = open(get_data("a4s51.xml"), "rb")

    def tearDown(self):
        self.xml_a251.close()
        self.xml_a351.close()
        self.xml_a451.close()
        self.xml_a2551.close()
        self.xml_a151.close()
        self.xml_a251.close()
        self.xml_a2851.close()
        self.xml_a2951.close()
        self.xml_a2551.close()
        self.xml_a2651.close()
        self.xml_a351.close()
        self.xml_a3s51.close()
        self.xml_a451.close()
        self.xml_a4s51.close()

    def test_a151(self):
        a151 = A1_51(self.xml_a151)
        a151.parse_xml()

        self.assertEqual(a151.comreferencenum, u'000123456789')
        self.assertEqual(a151.cups, u'ES1234000000000001JN')
        self.assertEqual(a151.reqdate, u'2018-05-01')
        self.assertEqual(a151.reqhour, u'13:00:00')
        self.assertEqual(a151.solicitudreferencia, u'123456')
        self.assertEqual(a151.tiporeposicion, u'01')
        self.assertEqual(a151.documenttype, u'01')
        self.assertEqual(a151.documentnum, u'ES11111111H')
        self.assertEqual(a151.titulartype, u'F')
        self.assertEqual(a151.extrainfo, u'comentarios extras')

    def test_a251(self):
        a251 = A1_51(self.xml_a251)
        a251.parse_xml()
        self.assertEqual(a251.reqcode, u'0123456789')
        self.assertEqual(a251.responsedate, u'2018-05-01')
        self.assertEqual(a251.responsehour, u'13:00:00')
        self.assertEqual(a251.comreferencenum, u'000123456789')
        self.assertEqual(a251.cups, u'ES1234000000000001JN')
        self.assertEqual(a251.result, u'01')
        self.assertEqual(a251.resultdesc, u'Aceptada')
        self.assertEqual(a251.resultreason, u'R32')
        self.assertEqual(a251.resultreasondesc, u'Fecha efecto solicitada anterior al día actual.')
        self.assertEqual(a251.indactcampo, u'S')
        self.assertEqual(a251.foreseentransferdate, u'2018-05-02')
        self.assertEqual(a251.extrainfo, u'Coments')

    def test_a351(self):
        a351 = A1_51(self.xml_a351)
        a351.parse_xml()
        self.assertEqual(a351.reqcode, u'0123456789')
        self.assertEqual(a351.comreferencenum, u'000123456789')
        self.assertEqual(a351.responsedate, u'2018-05-01')
        self.assertEqual(a351.responsehour, u'13:00:00')
        self.assertEqual(a351.cups, u'ES1234000000000001JN')
        self.assertEqual(a351.atrcode, u'000111222333444555666777')
        self.assertEqual(a351.resactivacion, u'01')
        self.assertEqual(a351.transfereffectivedate, u'2018-07-01')
        self.assertEqual(a351.enservicio, u'S')
        self.assertEqual(a351.titulartype, u'F')
        self.assertEqual(a351.nationality, u'ES')
        self.assertEqual(a351.documenttype, u'01')
        self.assertEqual(a351.documentnum, u'11111111H')
        self.assertEqual(a351.tolltype, u'R1')
        self.assertEqual(a351.telemetering, u'S')
        self.assertEqual(a351.finalqdgranted, u'987654321.1234567')
        self.assertEqual(a351.finalqhgranted, u'987654321')
        self.assertEqual(a351.finalclientyearlyconsumption, u'665544332211')
        self.assertEqual(a351.gasusetype, u'01')
        self.assertEqual(a351.interventiondate, u'2016-01-01')
        self.assertEqual(a351.interventionhourfrom, u'09:00:00')
        self.assertEqual(a351.interventionhourto, u'12:00:00')
        self.assertEqual(a351.visitnumber, u'987')
        self.assertEqual(a351.lastinspectionsdate, u'2019-01-01')
        self.assertEqual(a351.lastinspectionsresult, u'01')
        self.assertEqual(a351.readingtype, u'A')
        self.assertEqual(a351.caecode, u'01')
        self.assertEqual(a351.canonircperiodicity, u'01')
        self.assertEqual(a351.StatusPS, u'1')
        self.assertEqual(a351.lectureperiodicity, u'02')
        self.assertEqual(a351.extrainfo, u'comentarios extras')

        counter = a351.counterlist[0]
        self.assertEqual(counter.countermodel, u'marca1')
        self.assertEqual(counter.countertype, u'tipo1')
        self.assertEqual(counter.counternumber, u'B123456')
        self.assertEqual(counter.counterproperty, u'04')
        ...
        corrector = a351.correctorlist[0]
        self.assertEqual(corrector.correctormodel, u'modelo1')
        self.assertEqual(corrector.correctortype, u'01')
        self.assertEqual(corrector.correctornumber, u'D123456')
        self.assertEqual(corrector.correctorproperty, u'01')
    ...
    def test_a451(self):
        a451 = A1_51(self.xml_a451)
        a451.parse_xml()
        self.assertEqual(a451.reqcode, u'0123456789')
        self.assertEqual(a451.comreferencenum, u'000123456789')
        self.assertEqual(a451.responsedate, u'2018-05-01')
        self.assertEqual(a451.responsehour, u'13:00:00')
        self.assertEqual(a451.result, u'13')
        self.assertEqual(a451.resultdesc, u'No Realizada')
        self.assertEqual(a451.resultreason, u'R32')
        self.assertEqual(a451.resultreasondesc, u'Fecha efecto solicitada anterior al día actual.')
        self.assertEqual(a451.nationality, u'ES')
        self.assertEqual(a451.titulartype, u'F')
        self.assertEqual(a451.documenttype, u'01')
        self.assertEqual(a451.documentnum, u'11111111H')
        self.assertEqual(a451.cups, u'ES1234000000000001JN')
        self.assertEqual(a451.extrainfo, u'comentarios extras')

    def test_a3s51(self):
        a3s51 = A1_51(self.xml_a3s51)
        a3s51.parse_xml()
        self.assertEqual(a3s51.reqcode, u'0123456789')
        self.assertEqual(a3s51.responsedate, u'2018-05-01')
        self.assertEqual(a3s51.responsehour, u'13:00:00')
        self.assertEqual(a3s51.comreferencenum, u'000123456789')
        self.assertEqual(a3s51.resactivacion, u'01')
        self.assertEqual(a3s51.nationality, u'ES')
        self.assertEqual(a3s51.documenttype, u'01')
        self.assertEqual(a3s51.documentnum, u'11111111H')
        self.assertEqual(a3s51.cups, u'ES1234000000000001JN')
        self.assertEqual(a3s51.previousatrcode, u'000111222333444555666777')
        self.assertEqual(a3s51.transfereffectivedate, u'2018-07-02')
        self.assertEqual(a3s51.readingtype, u'A')
        self.assertEqual(a3s51.extrainfo, u'comentarios extras')
        counter = a3s51.counterlist[0]
        self.assertEqual(counter.countermodel, u'marca1')
        self.assertEqual(counter.countertype, u'tipo1')
        self.assertEqual(counter.counternumber, u'B123456')
        self.assertEqual(counter.counterproperty, u'04')
        self.assertEqual(counter.reallecture, u'2000')
        self.assertEqual(counter.counterpressure, u'54321.123')
        corrector = a3s51.correctorlist[0]
        self.assertEqual(corrector.correctormodel, u'modelo1')
        self.assertEqual(corrector.correctortype, u'01')
        self.assertEqual(corrector.correctornumber, u'D123456')
        self.assertEqual(corrector.correctorproperty, u'01')
    ...
    def test_a4s51(self):
        a4s51 = A1_51(self.xml_a4s51)
        a4s51.parse_xml()
        self.assertEqual(a4s51.reqcode, u'0123456789')
        self.assertEqual(a4s51.responsedate, u'2018-05-01')
        self.assertEqual(a4s51.responsehour, u'13:00:00')
        self.assertEqual(a4s51.result, u'13')
        self.assertEqual(a4s51.resultdesc, u'No Realizada')
        self.assertEqual(a4s51.resultreason, u'R32')
        self.assertEqual(a4s51.resultreasondesc, u'Fecha efecto solicitada anterior al día actual.')
        self.assertEqual(a4s51.cups, u'ES1234000000000001JN')
        self.assertEqual(a4s51.extrainfo, u'comentarios extras')

    def test_a2551(self):
        a2551 = A1_51(self.xml_a2551)
        a2551.parse_xml()
        self.assertEqual(a2551.reqcode, u'0123456789')
        self.assertEqual(a2551.cups, u'ES1234000000000001JN')
        self.assertEqual(a2551.visitdate, u'2018-05-01')
        self.assertEqual(a2551.visithour, u'12:00:00')
        self.assertEqual(a2551.comreferencenum, u'000123456789')
        self.assertEqual(a2551.informationtype, u'002')
        self.assertEqual(a2551.informationtypedesc, u'Orden de Trabajo pendiente')
        self.assertEqual(a2551.interventiondate, u'2016-01-01')
        self.assertEqual(a2551.interventionhourfrom, u'09:00:00')
        self.assertEqual(a2551.interventionhourto, u'12:00:00')
        self.assertEqual(a2551.visitnumber, u'987')
        self.assertEqual(a2551.operationnum, u'9874')
        self.assertEqual(a2551.extrainfo, u'Coments')
        defect = a2551.defectlist[0]
        self.assertEqual(defect.code, u'001')
        self.assertEqual(defect.description, u'Desc1')

    def test_a2651(self):
        a2651 = A1_51(self.xml_a2651)
        a2651.parse_xml()
        self.assertEqual(a2651.reqcode, u'7777')
        self.assertEqual(a2651.cups, u'ES1234000000000001JN')
        self.assertEqual(a2651.comreferencenum, u'000123456789')
        self.assertEqual(a2651.stateincidence, u'01')
        contact = a2651.contact
        self.assertEqual(contact.contactname, u'mortdegana')
        ...
        self.assertEqual(contact.contactemail, u'matalas@gas')
        self.assertEqual(a2651.extrainfo, u'comentarios extra')

    def test_a2851(self):
        a2851 = A1_51(self.xml_a2851)
        a2851.parse_xml()
        self.assertEqual(a2851.reqcode, u'0123456789')
        self.assertEqual(a2851.responsedate, u'2018-05-01')
        self.assertEqual(a2851.responsehour, u'13:00:00')
        self.assertEqual(a2851.cups, u'ES1234000000000001JN')
        self.assertEqual(a2851.solicitudreferencia, u'123456')
        self.assertEqual(a2851.tiporeposicion, u'01')
        self.assertEqual(a2851.indactcampo, u'S')
        self.assertEqual(a2851.foreseentransferdate, u'2018-05-02')
        self.assertEqual(a2851.province, u'01')
        self.assertEqual(a2851.city, u'00001')
        self.assertEqual(a2851.zipcode, u'5_MLU')
        self.assertEqual(a2851.streettype, u'ACCE')
        self.assertEqual(a2851.street, u'60_vdL9HZyoO6RyPRQnmirjeDxoLX0Uej')
        self.assertEqual(a2851.streetnumber, u'4_tS')
        self.assertEqual(a2851.portal, u'5_PUQ')
        self.assertEqual(a2851.staircase, u'5_7bv')
        self.assertEqual(a2851.floor, u'5_DLx')
        self.assertEqual(a2851.door, u'5_mmC')

    def test_a2951(self):
        a2951 = A1_51(self.xml_a2951)
        a2951.parse_xml()
        self.assertEqual(a2951.reqcode, u'0123456789')
        self.assertEqual(a2951.reqdate, u'2018-05-01')
        self.assertEqual(a2951.reqhour, u'12:00:00')
        self.assertEqual(a2951.responsedate, u'2018-05-01')
        self.assertEqual(a2951.responsehour, u'13:00:00')
        self.assertEqual(a2951.cups, u'ES1234000000000001JN')
        self.assertEqual(a2951.result, u'01')
        self.assertEqual(a2951.resultreason, u'R32')
        self.assertEqual(a2951.extrainfo, u'Coments')
...
class test_A1_41(unittest.TestCase):
    ...
    def test_a341(self):
        ...
        a1_41.parse_xml()
        self.assertEqual(a1_41.StatusPS, '1')
        self.assertEqual(a1_41.activationtype, '001')
        self.assertEqual(a1_41.activationtypedesc, 'Realizada puesta en servicio')
        self.assertEqual(a1_41.atrcode, '000111222333444555666777')
        self.assertEqual(a1_41.canonircperiodicity, '01')
        self.assertEqual(a1_41.cityowner, '17001')
        self.assertEqual(a1_41.closingtype, '001')
        self.assertEqual(a1_41.closingtypedesc, 'La Actualización de Datos se ha realizado correctamente')
        self.assertEqual(a1_41.comreferencenum, '000123456789')
        self.assertEqual(a1_41.cups, 'ES1234000000000001JN')
        self.assertEqual(a1_41.documentnum, '11111111H')
        self.assertEqual(a1_41.documenttype, '01')
        self.assertEqual(a1_41.doorowner, 'v')
        self.assertEqual(a1_41.email, 'gasalmatalas@atr.cat')
        self.assertEqual(a1_41.extrainfo, 'comentarios extras')
        self.assertEqual(a1_41.familyname1, 'Al')
        self.assertEqual(a1_41.familyname2, 'Matalas')
        self.assertEqual(a1_41.finalclientyearlyconsumption, '665544332211')
        self.assertEqual(a1_41.finalqdgranted, '987654321.1234567')
        self.assertEqual(a1_41.finalqhgranted, '987654321')
        self.assertEqual(a1_41.firstname, 'Gas')
        self.assertEqual(a1_41.floorowner, '4')
        self.assertEqual(a1_41.gasusetype, '01')
        ...
        self.assertEqual(a1_41.language, '01')
        self.assertEqual(a1_41.lastinspectionsdate, '2017-01-01')
        self.assertEqual(a1_41.lastinspectionsresult, '01')
        self.assertEqual(a1_41.lectureperiodicity, '02')
        self.assertEqual(a1_41.nationality, 'ES')
        self.assertEqual(a1_41.portalowner, '2')
        self.assertEqual(a1_41.provinceowner, '17')
        self.assertEqual(a1_41.readingtype, '1')
        self.assertEqual(a1_41.regularaddress, 'S')
        self.assertEqual(a1_41.reqcode, '0123456789')
        self.assertEqual(a1_41.responsedate, '2018-05-01')
        self.assertEqual(a1_41.responsehour, '13:00:00')
        self.assertEqual(a1_41.result, '09')
        self.assertEqual(a1_41.resultdesc, 'Realizada')
        self.assertEqual(a1_41.staircaseowner, '3')
        self.assertEqual(a1_41.streetnumberowner, '1')
        self.assertEqual(a1_41.streetowner, 'Carrer inventat')
        self.assertEqual(a1_41.streettypeowner, 'ACCE')
        self.assertEqual(a1_41.telemetering, 'S')
        self.assertEqual(a1_41.telephone1, '999888777')
        self.assertEqual(a1_41.telephone2, '666555444')
        self.assertEqual(a1_41.titulartype, 'F')
        self.assertEqual(a1_41.transfereffectivedate, '2018-07-01')
        self.assertEqual(a1_41.updatereason, '01')
        self.assertEqual(a1_41.visitnumber, '987')
        self.assertEqual(a1_41.zipcodeowner, '17002')
        self.assertEqual(len(a1_41.correctorlis), 2)
        corrector = a1_41.correctorlis[0]
        self.assertEqual(corrector.correctedlecture, '2200')
        self.assertEqual(corrector.correctormodel, 'modelo1')
        self.assertEqual(corrector.correctornumber, 'D123456')
        self.assertEqual(corrector.correctorproperty, '01')
        self.assertEqual(corrector.correctortype, '01')
        self.assertEqual(len(a1_41.counterlist), 2)
        counter = a1_41.counterlist[1]
        self.assertEqual(counter.countermodel, 'marca2')
        self.assertEqual(counter.counternumber, 'C123456')
        self.assertEqual(counter.counterpressure, '13245.321')

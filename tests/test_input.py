...
class test_A1_44(unittest.TestCase):
    ...
    def test_a244(self):
        ...
        a244.parse_xml()
        self.assertEqual(a244.reqcode, '0123456789')
        self.assertEqual(a244.reqdate, '2018-05-01')
        self.assertEqual(a244.reqhour, '13:00:00')
        self.assertEqual(a244.comreferencenum, '000123456789')
        self.assertEqual(a244.cups, 'ES1234000000000001JN')
        self.assertEqual(a244.operationtype, 'A10011')
        self.assertEqual(a244.responsedate, '2018-05-01')
        self.assertEqual(a244.responsehour, '13:00:00')
        self.assertEqual(a244.result, '01')
        self.assertEqual(a244.resultdesc, 'Aceptada')
        self.assertEqual(a244.resultreason, 'R32')
        self.assertEqual(a244.resultreasondesc, 'Fecha efecto solicitada anterior al día actual.')
        self.assertEqual(a244.srcode, '998877665544332211')
        self.assertEqual(a244.extrainfo, 'Coments')

    def test_a344(self):
        a344 = A1_44(self.xml_a344)
        a344.parse_xml()
        self.assertEqual(a344.reqcode, '0123456789')
        self.assertEqual(a344.reqdate, '2018-05-01')
        self.assertEqual(a344.reqhour, '13:00:00')
        self.assertEqual(a344.comreferencenum, '000123456789')
        self.assertEqual(a344.cups, 'ES1234000000000001JN')
        self.assertEqual(a344.operationtype, 'A10011')
        self.assertEqual(a344.responsedate, '2018-05-01')
        self.assertEqual(a344.responsehour, '13:00:00')
        self.assertEqual(a344.result, '09')
        self.assertEqual(a344.resultdesc, 'Realizada')
        ...
        self.assertEqual(a344.reqdescription, 'Desc')
        self.assertEqual(a344.interventiondate, u'2016-01-01')
        self.assertEqual(a344.interventionhour, u'09:00:00')
        self.assertEqual(a344.resultinspection, '01')
        self.assertEqual(a344.resultinspectiondesc, 'Correcto')
        self.assertEqual(a344.operationnum, '9874')
        self.assertEqual(a344.visitnumber, '0000')
        self.assertEqual(a344.counterchange, 'S')
        self.assertEqual(a344.removallecture, '56')
        self.assertEqual(a344.supplystatus, '05')
        self.assertEqual(a344.supplystatusdesc, 'CORTE POR FALTA DE PAGO')
        self.assertEqual(a344.servicestatus, '00')
        self.assertEqual(a344.servicestatusdesc, 'EN SERVICIO')
        self.assertEqual(a344.extrainfo, 'Coment')
        self.assertEqual(a344.conceptnumber, '2')
        self.assertEqual(len(a344.conceptlist), 2)
        concept = a344.conceptlist[1]
        self.assertEqual(concept.level, '1')
        self.assertEqual(concept.code, '0002')
        self.assertEqual(concept.description, 'Desc')
        self.assertEqual(concept.periodicity, '03')
        self.assertEqual(concept.units, '1')
        self.assertEqual(concept.unitimport, '23.8')
        self.assertEqual(concept.import_, '23.8')
        ...
        self.assertEqual(defect.code, '002')
        self.assertEqual(defect.description, 'Desc2')
        self.assertEqual(len(a344.registerdoclist), 2)
        registerdoc = a344.registerdoclist[1]
        self.assertEqual(registerdoc.date, '2018-01-01')
        self.assertEqual(registerdoc.doctype, '02')
        self.assertEqual(registerdoc.url, 'http://gasalmatalas.com')
        self.assertEqual(registerdoc.extrainfo, 'Comments')

#!/usr/bin/env python
# -*- coding: utf-8 -*-
from gestionatr.input.messages import C1, C2, A3, B1, B2, M1, D1, W1, Q1, R1, F1, Deadlines, \
...
class test_A1_38(unittest.TestCase):
    ...
    def test_a338(self):
        ...
        self.assertEqual(a338.resultinspection, u"01")
        self.assertEqual(a338.resultinspectiondesc, u"CORRECTO")

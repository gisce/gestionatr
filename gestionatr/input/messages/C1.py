...
class Autoconsumo(object):
    ...
    def tipo_autoconsumo(self):
        data = ''
        try:
            data = self.autoconsumo.TipoAutoconsumo.text
        except AttributeError:
            pass
        return data
    ...
    def tipo_subseccion(self):
        data = ''
        try:
            data = self.autoconsumo.TipoSubseccion.text
        except AttributeError:
            pass
        return data
    ...
    def datos_cau(self):
        data = []
        try:
            for cau in self.autoconsumo.DatosCAU:
                data.append(DatosCAU(cau))
        except AttributeError:
            pass
        return data
...
class DatosCAU(object):
    ...
    def datos_inst_gen(self):
        data = []
        try:
            for gen in self.datos_cau.DatosInstGen:
                data.append(DatosInstGen(gen))
        except AttributeError:
            pass
        return data

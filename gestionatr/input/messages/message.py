...
XSD_DATA = {'F1': {'01': 'Facturacion.xsd'},
            ...
            'E2': {'01': 'SolicitudReposicion.xsd',
                   '02': ('AceptacionReposicion.xsd', 'Rechazo.xsd'),
                   '03': 'IncidenciasATRDistribuidor.xsd',
                   '04': 'Rechazo.xsd',
                   '05': 'ActivacionReposicion.xsd',
                   '06': 'NotificacionActivacionPorReposicion.xsd',
                   '08': 'AnulacionSolicitud.xsd',
                   '09': ('AceptacionAnulacion.xsd',
                          'Rechazo.xsd'),
                   '10': 'AceptacionAnulacion.xsd',
                   '12': 'RechazoReposicion.xsd',
                   '13': 'ContestacionIncidencia.xsd',
                   '14': 'ConsultaSolicitudReposicion.xsd',
                   '15': ('AceptacionReposicionReceptor.xsd', 'RechazoReposicionReceptor.xsd')
                   },
            ...
            'M2': {
                   '02': 'Rechazo.xsd',
                   '05': 'ActivacionModificacionDeATRUnidir.xsd',
                   },
...
MAIN_MESSAGE_XSD = {
    ...
    'AceptacionReposicion': 'AceptacionReposicion',
    ...
    'ActivacionModificacionDeATRUnidir': 'ActivacionModificaciones',
